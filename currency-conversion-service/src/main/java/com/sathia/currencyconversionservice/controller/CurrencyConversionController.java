package com.sathia.currencyconversionservice.controller;
...
import com.sathia.currencyconversionservice.bean.CurrencyConversion;
import com.sathia.currencyconversionservice.proxy.CurrencyExchangeProxy;
...
public class CurrencyConversionController {
	...
	public CurrencyConversion calculateCurrencyConversionFeign(@PathVariable String from, @PathVariable String to, @PathVariable String quantity) {
		
		HashMap<String, String> uriVariables = new HashMap<>();
		uriVariables.put("from", from);
		uriVariables.put("to", to);
		CurrencyConversion currencyConversion = currencyExchangeProxy.retriveExchangeValue(from, to);
		currencyConversion.setQuantity(50L);
